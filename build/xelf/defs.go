...
//
//go:generate stringer -linecomment -output=stringers.go -type=Class,SectionType,Data,OSABI,Type,Machine,SectionIndex,ProgType,sectionFlag,progFlag,NType,dynFlag1,SymVis,SymBind,SymType,RX86_64,RAARCH64,RAlpha,RARM,R386,R390,RMIPS,RLoongArch,RPPC,RPPC64,RRISCV,RSPARC
...
const (
	...
	DF_ORIGIN dynFlag = 0x0001 // origin
	// Indicates "symbolic" linking
	DF_SYMBOLIC dynFlag = 0x0002 // symbolic
	// Indicates there may be relocations in non-writable segments
	DF_TEXTREL dynFlag = 0x0004 // text-rel
...
const (
	...
	DF_1_INTERPOSE dynFlag1 = 0x00000400 // interpose
	// Indicates that the search for dependencies of this object ignores any
	// default library search paths.
	DF_1_NODEFLIB dynFlag1 = 0x00000800 // no-deflib
	...
	// objects using.
	DF_1_NODUMP dynFlag1 = 0x00001000 // no-dump
	...
	DF_1_CONFALT dynFlag1 = 0x00002000 // config-alt
	// Meaningful only for filtees. Terminates a filters search for any
	// further filtees.
	DF_1_ENDFILTEE dynFlag1 = 0x00004000 // end-filtee
	// Indicates that this object has displacement relocations applied.
	DF_1_DISPRELDNE dynFlag1 = 0x00008000 // displace-rel-dne
	// Indicates that this object has displacement relocations pending.
	DF_1_DISPRELPND dynFlag1 = 0x00010000 // displace-rel-pending
	// Indicates that this object contains symbols that cannot be directly
	// bound to.
	DF_1_NODIRECT dynFlag1 = 0x00020000 // no-direct
	// Reserved for internal use by the kernel runtime-linker.
	DF_1_IGNMULDEF dynFlag1 = 0x00040000 // ign-mul-def
	// Reserved for internal use by the kernel runtime-linker.
	DF_1_NOKSYMS dynFlag1 = 0x00080000 // no-k-syms
	// Reserved for internal use by the kernel runtime-linker.
	DF_1_NOHDR dynFlag1 = 0x00100000 // no-hdr
	...
	DF_1_EDITED dynFlag1 = 0x00200000 // edited
	// Reserved for internal use by the kernel runtime-linker.
	DF_1_NORELOC dynFlag1 = 0x00400000 // no-reloc
	...
	// executable.
	DF_1_SYMINTPOSE dynFlag1 = 0x00800000 // sym-int-pose
	// Indicates that the executable requires global auditing.
	DF_1_GLOBAUDIT dynFlag1 = 0x01000000 // glob-audit
	// Indicates that the object defines, or makes reference to singleton symbols.
	DF_1_SINGLETON dynFlag1 = 0x02000000 // singleton
	// Indicates that the object is a stub.
	DF_1_STUB dynFlag1 = 0x04000000 // stub
	// Indicates that the object is a position-independent executable.
	DF_1_PIE dynFlag1 = 0x08000000 // pie
	// Indicates that the object is a kernel module.
	DF_1_KMOD dynFlag1 = 0x10000000 // kernel-module
	// Indicates that the object is a weak standard filter.
	DF_1_WEAKFILTER dynFlag1 = 0x20000000 // weak-filter
	// Unused.
	DF_1_NOCOMMON dynFlag1 = 0x40000000 // no-common
)
