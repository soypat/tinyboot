// Code generated by "stringer -linecomment -output=stringers.go -type=Class,SectionType,Data,OSABI,Type,Machine,SectionIndex,ProgType,sectionFlag,progFlag,NType,dynFlag1,SymVis,SymBind,SymType,RX86_64,RAARCH64,RAlpha,RARM,R386,R390,RMIPS,RLoongArch,RPPC,RPPC64,RRISCV,RSPARC"; DO NOT EDIT.
...
func _() {
	...
	_ = x[DF_1_GROUP-4]
	_ = x[DF_1_NODELETE-8]
	_ = x[DF_1_LOADFLTR-16]
	_ = x[DF_1_INITFIRST-32]
	_ = x[DF_1_NOOPEN-64]
	_ = x[DF_1_ORIGIN-128]
	_ = x[DF_1_DIRECT-256]
	_ = x[DF_1_TRANS-512]
	_ = x[DF_1_INTERPOSE-1024]
	_ = x[DF_1_NODEFLIB-2048]
	_ = x[DF_1_NODUMP-4096]
	_ = x[DF_1_CONFALT-8192]
	_ = x[DF_1_ENDFILTEE-16384]
	_ = x[DF_1_DISPRELDNE-32768]
	_ = x[DF_1_DISPRELPND-65536]
	_ = x[DF_1_NODIRECT-131072]
	_ = x[DF_1_IGNMULDEF-262144]
	_ = x[DF_1_NOKSYMS-524288]
	_ = x[DF_1_NOHDR-1048576]
	_ = x[DF_1_EDITED-2097152]
	_ = x[DF_1_NORELOC-4194304]
	_ = x[DF_1_SYMINTPOSE-8388608]
	_ = x[DF_1_GLOBAUDIT-16777216]
	_ = x[DF_1_SINGLETON-33554432]
	_ = x[DF_1_STUB-67108864]
	_ = x[DF_1_PIE-134217728]
	_ = x[DF_1_KMOD-268435456]
	_ = x[DF_1_WEAKFILTER-536870912]
	_ = x[DF_1_NOCOMMON-1073741824]
}

const _dynFlag1_name = "nowglobalgroupno-deleteload-filterinit-firstno-openorigindirecttransinterposeno-deflibno-dumpconfig-altend-filteedisplace-rel-dnedisplace-rel-pendingno-directign-mul-defno-k-symsno-hdreditedno-relocsym-int-poseglob-auditsingletonstubpiekernel-moduleweak-filterno-common"

var _dynFlag1_map = map[dynFlag1]string{
	1:          _dynFlag1_name[0:3],
	2:          _dynFlag1_name[3:9],
	4:          _dynFlag1_name[9:14],
	8:          _dynFlag1_name[14:23],
	16:         _dynFlag1_name[23:34],
	32:         _dynFlag1_name[34:44],
	64:         _dynFlag1_name[44:51],
	128:        _dynFlag1_name[51:57],
	256:        _dynFlag1_name[57:63],
	512:        _dynFlag1_name[63:68],
	1024:       _dynFlag1_name[68:77],
	2048:       _dynFlag1_name[77:86],
	4096:       _dynFlag1_name[86:93],
	8192:       _dynFlag1_name[93:103],
	16384:      _dynFlag1_name[103:113],
	32768:      _dynFlag1_name[113:129],
	65536:      _dynFlag1_name[129:149],
	131072:     _dynFlag1_name[149:158],
	262144:     _dynFlag1_name[158:169],
	524288:     _dynFlag1_name[169:178],
	1048576:    _dynFlag1_name[178:184],
	2097152:    _dynFlag1_name[184:190],
	4194304:    _dynFlag1_name[190:198],
	8388608:    _dynFlag1_name[198:210],
	16777216:   _dynFlag1_name[210:220],
	33554432:   _dynFlag1_name[220:229],
	67108864:   _dynFlag1_name[229:233],
	134217728:  _dynFlag1_name[233:236],
	268435456:  _dynFlag1_name[236:249],
	536870912:  _dynFlag1_name[249:260],
	1073741824: _dynFlag1_name[260:269],
}

func (i dynFlag1) String() string {
	if str, ok := _dynFlag1_map[i]; ok {
		return str
	}
	return "dynFlag1(" + strconv.FormatInt(int64(i), 10) + ")"
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func _() {
	...
	_ = x[R390GOTPLT32-31]
	_ = x[R390GOTPLT64-32]
	_ = x[R390GOTPLTENT-33]
	_ = x[R390GOTPLTOFF16-34]
	_ = x[R390GOTPLTOFF32-35]
	_ = x[R390GOTPLTOFF64-36]
	_ = x[R390TLS_LOAD-37]
	_ = x[R390TLS_GDCALL-38]
	_ = x[R390TLS_LDCALL-39]
	_ = x[R390TLS_GD32-40]
	_ = x[R390TLS_GD64-41]
	_ = x[R390TLS_GOTIE12-42]
	_ = x[R390TLS_GOTIE32-43]
	_ = x[R390TLS_GOTIE64-44]
	_ = x[R390TLS_LDM32-45]
	_ = x[R390TLS_LDM64-46]
	_ = x[R390TLS_IE32-47]
	_ = x[R390TLS_IE64-48]
	_ = x[R390TLS_IEENT-49]
	_ = x[R390TLS_LE32-50]
	_ = x[R390TLS_LE64-51]
	_ = x[R390TLS_LDO32-52]
	_ = x[R390TLS_LDO64-53]
	_ = x[R390TLS_DTPMOD-54]
	_ = x[R390TLS_DTPOFF-55]
	_ = x[R390TLS_TPOFF-56]
	_ = x[R39020-57]
	_ = x[R390GOT20-58]
	_ = x[R390GOTPLT20-59]
	_ = x[R390TLS_GOTIE20-60]
}

const _R390_name = "None8121632PC32GOT12GOT32PLT32COPYGLOB_DATJMP_SLOTRELATIVEGOTOFFGOTPCGOT16PC16PC16DBLPLT16DBLPC32DBLPLT32DBLGOTPCDBL64PC64GOT64PLT64GOTENTGOTOFF16GOTOFF64GOTPLT12GOTPLT16GOTPLT32GOTPLT64GOTPLTENTGOTPLTOFF16GOTPLTOFF32GOTPLTOFF64TLS_LOADTLS_GDCALLTLS_LDCALLTLS_GD32TLS_GD64TLS_GOTIE12TLS_GOTIE32TLS_GOTIE64TLS_LDM32TLS_LDM64TLS_IE32TLS_IE64TLS_IEENTTLS_LE32TLS_LE64TLS_LDO32TLS_LDO64TLS_DTPMODTLS_DTPOFFTLS_TPOFF20GOT20GOTPLT20TLS_GOTIE20"
...
func _() {
	...
	_ = x[RSPARCWPLT30-18]
	_ = x[RSPARCCOPY-19]
	_ = x[RSPARCGLOB_DAT-20]
	_ = x[RSPARCJMP_SLOT-21]
	_ = x[RSPARCRELATIVE-22]
	_ = x[RSPARCUA32-23]
	_ = x[RSPARCPLT32-24]
	_ = x[RSPARCHIPLT22-25]
	_ = x[RSPARCLOPLT10-26]
	_ = x[RSPARCPCPLT32-27]
	_ = x[RSPARCPCPLT22-28]
	_ = x[RSPARCPCPLT10-29]
	_ = x[RSPARC10-30]
	_ = x[RSPARC11-31]
	_ = x[RSPARC64-32]
	_ = x[RSPARCOLO10-33]
	...
	_ = x[RSPARCHM10-35]
	_ = x[RSPARCLM22-36]
	_ = x[RSPARCPC_HH22-37]
	_ = x[RSPARCPC_HM10-38]
	_ = x[RSPARCPC_LM22-39]
	_ = x[RSPARCWDISP16-40]
	_ = x[RSPARCWDISP19-41]
	_ = x[RSPARCGLOB_JMP-42]
	_ = x[RSPARC7-43]
	_ = x[RSPARC5-44]
	_ = x[RSPARC6-45]
	_ = x[RSPARCDISP64-46]
	...
	_ = x[RSPARCM44-51]
	_ = x[RSPARCL44-52]
	_ = x[RSPARCREGISTER-53]
	_ = x[RSPARCUA64-54]
	_ = x[RSPARCUA16-55]
}

const _RSPARC_name = "None81632DISP8DISP16DISP32WDISP30WDISP22HI222213LO10GOT10GOT13GOT22PC10PC22WPLT30COPYGLOB_DATJMP_SLOTRELATIVEUA32PLT32HIPLT22LOPLT10PCPLT32PCPLT22PCPLT10101164OLO10HH22HM10LM22PC_HH22PC_HM10PC_LM22WDISP16WDISP19GLOB_JMP756DISP64PLT64HIX22LOX10H44M44L44REGISTERUA64UA16"
